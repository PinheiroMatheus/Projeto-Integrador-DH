...
<body>
    ...
    <div class="container row px-5 py-5">
        <div class="col-sm-6 col-md-6 col-lg-6 col-xs-12">
            ...
            <hr>
            <ul class="row pl-3" id="ul-contato">
                <li><a href="http://instagram.com"><img src="assets/img/instagram-logo.png" width="40px" class="pr-2" alt="" class=""></a></li>
                <li><a href="http://facebook.com"><img src="assets/img/facebook.logo.png" width="40px" class="pr-2" alt="" class=""></a></li>
                <li><a href="http://twitter.com"><img src="assets/img/twitter-logo.png" width="40px" class="pr-2" alt="" class=""></a></li>
            </ul>
        </div>
        <div class="col-sm-6 col-md-6 col-lg-6 col-xs-12">
            <div class="row pl-5">
